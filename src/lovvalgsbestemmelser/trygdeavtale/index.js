const {lovvalgsbestemmelser_trygdeavtale_au} = require('./lovvalgsbestemmelser_trygdeavtale_au');
const {lovvalgsbestemmelser_trygdeavtale_ba} = require('./lovvalgsbestemmelser_trygdeavtale_ba');
const {lovvalgsbestemmelser_trygdeavtale_ca} = require('./lovvalgsbestemmelser_trygdeavtale_ca');
...
const {lovvalgsbestemmelser_trygdeavtale_hr} = require('./lovvalgsbestemmelser_trygdeavtale_hr');
...
const {lovvalgsbestemmelser_trygdeavtale_si} = require('./lovvalgsbestemmelser_trygdeavtale_si');
const {lovvalgsbestemmelser_trygdeavtale_tr} = require('./lovvalgsbestemmelser_trygdeavtale_tr');
const {lovvalgsbestemmelser_trygdeavtale_us} = require('./lovvalgsbestemmelser_trygdeavtale_us');
...
module.exports.trygdeavtale = trygdeavtale;
